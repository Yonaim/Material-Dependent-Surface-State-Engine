...
namespace MDSS
{
    ...
    public:
         ...
         */
        void LoadSurfaceData(TMeshAssetHandle Mesh, const std::filesystem::path& DistributionPath = {});
        ...
        [[nodiscard]] bool                      HasSurfaceData(TMeshAssetHandle Handle) const noexcept;
        [[nodiscard]] const TSurfaceRuntimeData& GetSurfaceData(TMeshAssetHandle Handle) const;
        /** @brief Profile table order used by the Mesh's per-texel SurfaceProfileMap indices. */
        [[nodiscard]] const std::vector<TSRProfileAssetHandle>& GetSurfaceProfileTable(TMeshAssetHandle Handle) const;
    ...
    private:
        ...
        std::vector<std::shared_ptr<const TSurfaceRuntimeData>> SurfaceData;
        std::vector<std::vector<TSRProfileAssetHandle>>         SurfaceProfileTables;

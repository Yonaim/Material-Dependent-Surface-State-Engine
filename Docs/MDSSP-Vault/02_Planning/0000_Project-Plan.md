...
상태: **프로젝트 범위 및 목표 기준** · 일정 요약은 [[02_Planning/0001_Roadmap|Roadmap]], 각 주의 실행 계획은 [[02_Planning/Weekly/Week-01|Weekly Plans]]에서 관리한다.
...
- [[02_Planning/0001_Roadmap|Roadmap]]은 16주 전체의 순서와 주요 milestone을 요약한다.
- `Weekly/Week-XX.md`는 해당 주의 작업·산출물·범위 경계를 상세히 적는다.

...
상태: **파일 구조 설계** · 근거: [[05_Assets/Documents/Asset-Structure.pdf|에셋 구조]]

이 문서는 데이터의 **파일 직렬화와 Asset 연결 관계**만 정의한다. SRProfile 파라미터의 의미와 범위는 [[02_Architecture/Surface-State|표면 상태와 데이터 구조]]를 기준으로 한다.
...
Simulation UV를 OBJ의 기존 UV와 공유할지, 별도 생성·보조 Asset으로 저장할지는 아직 결정하지 않는다. [[TODO|TODO]]에서 후속 설계 항목으로 관리한다.

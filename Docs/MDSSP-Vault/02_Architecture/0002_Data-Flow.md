...
5. Solver가 Input / Transport / Decay를 사용해 다음 State를 계산한다. [[02_Architecture/0006_Propagation-Solver|Solver]]
6. State가 형상 적층을 만드는 경우 `Accumulation_Height`를 계산한다. [[02_Architecture/0008_Accumulation|적층]]
7. 적층으로 바뀐 Height / Normal / Distance / Curvature를 후속 Simulation과 Rendering에 다시 반영한다. [[02_Architecture/0007_Surface-Geometry|형상 정보]], [[02_Architecture/0010_Rendering|렌더링]]

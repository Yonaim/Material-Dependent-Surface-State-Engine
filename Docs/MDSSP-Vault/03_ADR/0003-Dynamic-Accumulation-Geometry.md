...
Instance마다 State가 다르므로 동적 형상 데이터의 실제 GPU 소유·저장 방식이 필요하다. 이 부분은 후속 GPU Resource 설계에서 정한다. [[02_Architecture/Accumulation|적층]], [[02_Architecture/Surface-Geometry|형상 정보]].
